//*********************************************************************
//*
//* MFS FOR THE NON-CONVERSATIONAL TP PROGRAM - HIDAM/OSAM DATA BASE
//*
//*********************************************************************
//*  MFSUTL Procedure
//*
...
//            LN=55,SN=8,DEVCHAR=I,COMPR3=NOCOMPREND,
//            DIRUPDT=UPDATE
...
//*SYSLIB - USER OPTION
//SYSIN    DD DISP=SHR,
//         DSN=&SYSUID..FORMAT(&MBR)
//REFIN    DD DSN=&SYSUID..IMS.REFERAL,DISP=OLD
//REFOUT   DD DSN=&SYSUID..IMS.REFERAL,DISP=OLD
//REFRD    DD DSN=&SYSUID..IMS.REFERAL,DISP=OLD
//SYSTEXT  DD DSN=&&TXTPASS,UNIT=SYSDA,
//         SPACE=(CYL,(1,1)),DCB=BLKSIZE=800
//SYSUT3   DD UNIT=SYSDA,SPACE=(CYL,(1,1))
//SYSUT4   DD UNIT=SYSDA,SPACE=(CYL,(1,1))
//DUMMY    DD DISP=SHR,
//         DSN=DFSF10.PROCLIB(REFCPY)
...
//SYSUDUMP DD SYSOUT=&SOUT
//*
//FORMAT   DD DSN=&SYSUID..FORMAT,DISP=SHR
//DUMMY    DD DISP=SHR,
//         DSN=DFSF10.PROCLIB(FMTCPY)
//SYSPRINT DD SYSOUT=&SOUT
//SYSUT3   DD UNIT=SYSDA,SPACE=(CYL,(1,1))
//SYSUT4   DD UNIT=SYSDA,SPACE=(CYL,(1,1))
//*
